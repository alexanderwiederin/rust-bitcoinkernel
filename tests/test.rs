...
mod tests {
    ...
    use bitcoinkernel::{
        ...
        PrecomputedTransactionData, ScriptError, ScriptPubkey, ScriptVerificationFlags,
        ScriptVerifyError, Transaction, TransactionSpentOutputs, TxIn, TxOut, ValidationMode,
    ...
    #[test]
    fn test_script_error_codes() {
        let p2pkh_tx = "";

        // OP_RETURN (0x6a) → OpReturn
        assert!(matches!(
            verify_test("6a", p2pkh_tx, 0, 0, vec![], VERIFY_ALL_PRE_TAPROOT),
            Err(KernelError::ScriptVerify(ScriptVerifyError::Script(
                ScriptError::OpReturn
            )))
        ));

        // OP_0 (0x00) pushes empty bytes → top of stack is false → EvalFalse
        assert!(matches!(
            verify_test("00", p2pkh_tx, 0, 0, vec![], VERIFY_ALL_PRE_TAPROOT),
            Err(KernelError::ScriptVerify(ScriptVerifyError::Script(
                ScriptError::EvalFalse
            )))
        ));

        // OP_EQUALVERIFY (0x88) pops sig and pubkey, they differ → EqualVerify
        assert!(matches!(
            verify_test("88", p2pkh_tx, 0, 0, vec![], VERIFY_ALL_PRE_TAPROOT),
            Err(KernelError::ScriptVerify(ScriptVerifyError::Script(
                ScriptError::EqualVerify
            )))
        ));

        // OP_IF (0x63) without OP_ENDIF → UnbalancedConditional
        assert!(matches!(
            verify_test("63", p2pkh_tx, 0, 0, vec![], VERIFY_ALL_PRE_TAPROOT),
            Err(KernelError::ScriptVerify(ScriptVerifyError::Script(
                ScriptError::UnbalancedConditional
            )))
        ));

        // OP_DROP OP_DROP OP_DROP (0x75 0x75 0x75): scriptSig pushes 2 items,
        // third OP_DROP has nothing to pop → InvalidStackOperation
        assert!(matches!(
            verify_test("757575", p2pkh_tx, 0, 0, vec![], VERIFY_ALL_PRE_TAPROOT),
            Err(KernelError::ScriptVerify(ScriptVerifyError::Script(
                ScriptError::InvalidStackOperation
            )))
        ));

        // OP_2MUL (0x8d) is a disabled opcode → DisabledOpcode
        assert!(matches!(
            verify_test("8d", p2pkh_tx, 0, 0, vec![], VERIFY_ALL_PRE_TAPROOT),
            Err(KernelError::ScriptVerify(ScriptVerifyError::Script(
                ScriptError::DisabledOpcode
            )))
        ));

        // P2PKH with wrong pubkey hash: OP_DUP OP_HASH160 <20 zero bytes> OP_EQUALVERIFY OP_CHECKSIG
        // Hash won't match the actual pubkey → EqualVerify
        assert!(matches!(
            verify_test(
    ...
    fn test_script_verify() {
        ...
        // a random old-style transaction from the blockchain - WITH BAD OPCODE replacing OP_CHECKSIG
        // scriptPubkey ends with 0xff instead of 0xac (OP_CHECKSIG), so EQUALVERIFY passes
        // (correct pubkey hash) but then 0xff is an undefined opcode → BadOpcode
        assert!(matches!(verify_test(
            "76a9144bfbaf6afb76cc5771bc6404810d1cc041a6933988ff",
            "",
            0, 0 , vec![], VERIFY_ALL_PRE_TAPROOT
        ), Err(KernelError::ScriptVerify(ScriptVerifyError::Script(ScriptError::BadOpcode)))));

        // a random segwit transaction from the blockchain using native segwit - WITH WRONG WITNESS HASH
        // Last byte of witness program changed (c58d → c58f), so hash doesn't match → WitnessProgramMismatch
        assert!(matches!(verify_test(
            "0020701a8d401c84fb13e6baf169d59684e17abd9fa216c8cc5b9fc63d622ff8c58f",
            "",
            18393430 , 0, vec![], VERIFY_ALL_PRE_TAPROOT
        ), Err(KernelError::ScriptVerify(ScriptVerifyError::Script(ScriptError::WitnessProgramMismatch)))));
    ...
    fn script_verify_p2pkh() {
        ...
        verify_test(spk, tx_valid, 0, 0, vec![], base_flags).unwrap();
        verify_test(spk, tx_valid, 0, 0, vec![], VERIFY_ALL_PRE_TAPROOT).unwrap();

        // same tx but with corrupted signature
        let tx_corrupted_sig = "";

        assert!(matches!(
            verify_test(spk, tx_corrupted_sig, 0, 0, vec![], base_flags),
            Err(KernelError::ScriptVerify(ScriptVerifyError::Script(_)))
        ));

        // same tx but with a non-DER signature
        let tx_non_der_sig = "";
        verify_test(spk, tx_non_der_sig, 0, 0, vec![], base_flags).unwrap();
        assert!(matches!(
            verify_test(
                spk,
                tx_non_der_sig,
    ...
    fn script_verify_p2sh_multisig() {
        ...
        let tx_valid = "";
        ...
        // same tx but with corrupted signature
        let tx_corrupted_sig = "";
        assert!(matches!(
            verify_test(spk, tx_corrupted_sig, 0, 0, vec![], base_flags),
            Err(KernelError::ScriptVerify(ScriptVerifyError::Script(_)))
        ));
        verify_test(
            ...
            0,
            vec![],
            base_flags & !VERIFY_P2SH,
        )
        .unwrap();

        // same tx but with a non-null dummy stack element
        let tx_non_null_dummy = "";
        verify_test(spk, tx_non_null_dummy, 0, 0, vec![], base_flags).unwrap();
        assert!(matches!(
            verify_test(
                spk,
                tx_non_null_dummy,
    ...
    fn script_verify_cltv() {
        ...
        let tx_locktime_100 = "";
        let base_flags = VERIFY_P2SH | VERIFY_CHECKLOCKTIMEVERIFY;

        verify_test(spk, tx_locktime_100, 0, 0, vec![], base_flags).unwrap();
        verify_test(spk, tx_locktime_100, 0, 0, vec![], VERIFY_ALL_PRE_TAPROOT).unwrap();

        // tx with locktime 50 (not satisfying CLTV condition)
        let tx_locktime_50 = "";
        assert!(matches!(
            verify_test(spk, tx_locktime_50, 0, 0, vec![], base_flags),
            Err(KernelError::ScriptVerify(ScriptVerifyError::Script(_)))
        ));
        verify_test(
            spk,
    ...
    fn script_verify_csv() {
        ...
        let tx_sequence_10 = "";
        let base_flags = VERIFY_P2SH | VERIFY_CHECKSEQUENCEVERIFY;

        verify_test(spk, tx_sequence_10, 0, 0, vec![], base_flags).unwrap();
        verify_test(spk, tx_sequence_10, 0, 0, vec![], VERIFY_ALL_PRE_TAPROOT).unwrap();

        // tx with input sequence 5 (not satisfying CSV condition)
        let tx_sequence_5 = "";
        assert!(matches!(
            verify_test(spk, tx_sequence_5, 0, 0, vec![], base_flags),
            Err(KernelError::ScriptVerify(ScriptVerifyError::Script(_)))
        ));
        verify_test(
            spk,
    ...
    fn script_verify_p2sh_p2wpkh() {
        ...
        let tx_valid = "";
        let amount = 1900000;
        let base_flags = VERIFY_P2SH | VERIFY_WITNESS;

        verify_test(spk, tx_valid, amount, 0, vec![], base_flags).unwrap();
        verify_test(spk, tx_valid, amount, 0, vec![], VERIFY_ALL_PRE_TAPROOT).unwrap();

        // same tx but with corrupted signature
        let tx_corrupted_sig = "";
        assert!(matches!(
            verify_test(spk, tx_corrupted_sig, amount, 0, vec![], base_flags),
            Err(KernelError::ScriptVerify(ScriptVerifyError::Script(_)))
        ));
        verify_test(
            spk,
    ...
    fn script_verify_p2sh_p2wsh() {
        ...
        let tx_valid = "";
        ...
        // same tx but with corrupted signature
        let tx_corrupted_sig = "";
        assert!(matches!(
            verify_test(spk, tx_corrupted_sig, amount, 0, vec![], base_flags),
            Err(KernelError::ScriptVerify(ScriptVerifyError::Script(_)))
        ));
    ...
    fn script_verify_p2wpkh() {
        ...
        let tx_valid = "";
        let amount = 5003;
        let base_flags = VERIFY_P2SH | VERIFY_WITNESS;
        ...
        // using wrong amount
        assert!(matches!(
            verify_test(spk, tx_valid, 5002, 0, vec![], base_flags),
            Err(KernelError::ScriptVerify(ScriptVerifyError::Script(_)))
        ));
        verify_test(spk, tx_valid, 5002, 0, vec![], base_flags & !VERIFY_WITNESS).unwrap();
    }
    ...
    fn script_verify_p2wsh() {
        ...
        let tx_valid = "";
        let amount = 1480000;
        let base_flags = VERIFY_P2SH | VERIFY_WITNESS;

        verify_test(spk, tx_valid, amount, 1, vec![], base_flags).unwrap();
        verify_test(spk, tx_valid, amount, 1, vec![], VERIFY_ALL_PRE_TAPROOT).unwrap();

        // same tx but with corrupted signature
        let tx_corrupted_sig = "";
        assert!(matches!(
            verify_test(spk, tx_corrupted_sig, amount, 1, vec![], base_flags),
            Err(KernelError::ScriptVerify(ScriptVerifyError::Script(_)))
        ));
        verify_test(
            spk,
    ...
    fn script_verify_p2tr_keypath() {
        ...
        let tx_valid  = "";
        let amount = 88480;
        ...
        verify_test(spk, tx_valid, amount, 0, outputs.clone(), base_flags).unwrap();
        verify_test(spk, tx_valid, amount, 0, outputs.clone(), VERIFY_ALL).unwrap();

        // same tx but with corrupted signature
        let tx_corrupted_sig  = "";
        assert!(matches!(
            verify_test(
                spk,
                tx_corrupted_sig,
    ...
    fn script_verify_p2tr_scriptpath() {
        ...
        let tx_valid  = "";
        let amount = 503185;
        let base_flags = VERIFY_P2SH | VERIFY_WITNESS | VERIFY_TAPROOT;
        let outputs = vec![
            TxOut::new(
        ...
        verify_test(spk, tx_valid, amount, 1, outputs.clone(), base_flags).unwrap();
        verify_test(spk, tx_valid, amount, 1, outputs.clone(), VERIFY_ALL).unwrap();

        // same tx but with corrupted signature
        let tx_corrupted_sig  = "";
        assert!(matches!(
            verify_test(
                spk,
                tx_corrupted_sig,
