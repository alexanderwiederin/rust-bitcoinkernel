...
use libbitcoinkernel_sys::{
    btck_Block, btck_BlockSpentOutputs, btck_BlockTreeEntry, btck_Coin,
    btck_TransactionSpentOutputs, btck_block_copy, btck_block_count_transactions,
    btck_block_create, btck_block_destroy, btck_block_get_hash, btck_block_get_transaction_at,
    btck_block_hash_destroy, btck_block_spent_outputs_copy, btck_block_spent_outputs_count,
    btck_block_spent_outputs_destroy, btck_block_spent_outputs_get_transaction_spent_outputs_at,
    btck_block_to_bytes, btck_block_tree_entry_get_block_hash, btck_block_tree_entry_get_height,
    btck_block_tree_entry_get_previous, btck_coin_confirmation_height, btck_coin_copy,
