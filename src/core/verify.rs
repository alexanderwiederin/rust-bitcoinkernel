...
use libbitcoinkernel_sys::{
    ...
    btck_ScriptError_SCRIPTNUM, btck_ScriptError_SCRIPT_SIZE, btck_ScriptError_SIG_COUNT,
    btck_ScriptError_SIG_DER, btck_ScriptError_SIG_FINDANDDELETE, btck_ScriptError_SIG_HASHTYPE,
    btck_ScriptError_SIG_HIGH_S, btck_ScriptError_SIG_NULLDUMMY, btck_ScriptError_SIG_NULLFAIL,
    btck_ScriptError_SIG_PUSHONLY, btck_ScriptError_STACK_SIZE,
    btck_ScriptError_TAPROOT_WRONG_CONTROL_SIZE, btck_ScriptError_TAPSCRIPT_CHECKMULTISIG,
    btck_ScriptError_TAPSCRIPT_EMPTY_PUBKEY, btck_ScriptError_TAPSCRIPT_MINIMALIF,
    btck_ScriptError_TAPSCRIPT_VALIDATION_WEIGHT, btck_ScriptError_UNBALANCED_CONDITIONAL,
    btck_ScriptError_UNKNOWN, btck_ScriptError_UNSATISFIED_LOCKTIME, btck_ScriptError_VERIFY,
...
impl Display for ScriptError {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        match self {
            ...
            ScriptError::ScriptNum => write!(f, "Script number encoding error"),
...
impl TryFrom<btck_ScriptError> for ScriptError {
    ...
    fn try_from(value: btck_ScriptError) -> Result<Self, Self::Error> {
        match value {
            ...
            btck_ScriptError_SCRIPTNUM => Ok(ScriptError::ScriptNum),
