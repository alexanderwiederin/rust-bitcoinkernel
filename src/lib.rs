...
pub use crate::core::{
    Block, BlockHash, BlockSpentOutputs, BlockTreeEntry, TransactionSpentOutputs,
};

pub mod prelude {
    pub use crate::core::{BlockSpentOutputsExt, CoinExt, TransactionSpentOutputsExt};
    pub use crate::{ScriptPubkeyExt, TransactionExt, TxOutExt};
}
