...
pub use crate::core::{
    ...
    BlockSpentOutputsRef, BlockTreeEntry, Coin, CoinRef, PrecomputedTransactionData, ScriptError,
    ScriptPubkey, ScriptPubkeyRef, ScriptVerificationFlags, ScriptVerifyError, Transaction,
