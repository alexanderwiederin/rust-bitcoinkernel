...
impl<'a> std::fmt::Debug for BlockSpentOutputsRef<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("BlockSpentOutputsRef")
            .field("transaction_count", &self.count())
            .finish()
    }
}
...
impl<'a> std::fmt::Debug for TransactionSpentOutputsRef<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("TransactionSpentOutputsRef")
            .field("coin_count", &self.count())
            .finish()
    }
}
...
impl<'a> std::fmt::Debug for CoinRef<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("CoinRef")
            .field("height", &self.confirmation_height())
            .field("coinbase", &self.is_coinbase())
            .field("value", &self.output().value())
            .finish()
    }
}
